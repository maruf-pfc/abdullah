...
export const metadata = {
  ...
  description:
    "Explore Muhammad Abdullah's undergraduate thesis on Mixed Convective Heat Transfer in a Square Cavity filled with Power-law Fluids under Active Flow Modulation.",
};
          ...
          <article className="max-w-4xl mx-auto">
            ...
            <section className="bg-white rounded-lg shadow-md p-6 mb-8">
              <h2 className="text-xl font-bold text-[#8B0000] mb-4 flex items-center">
                ...
                <span>
                  Mixed Convective Heat Transfer in a Square Cavity filled with
                  Power-law Fluids under Active Flow Modulation
                </span>
              </h2>
              <p className="mb-4">
